...
<body>
  ...
  <main class="site-main">
    ...
    <div class="form-group">
      <label for="yearU">Año Inicial</label>
      <input type="number" id="yearU" placeholder="YYYY" aria-describedby="emailHelp" class="form-control" min="2018" max="2050" />
    ...
    <div class="form-group" id="year2" style="display:none">
      <label for="yearU">Año Final</label>
      <input type="number" id="yearU" placeholder="YYYY" aria-describedby="emailHelp" class="form-control" min="2018" max="2050" />
      <small id="emailHelp" class="form-text text-muted">Digite el año a buscar en formato YYYY.</small>
    </div>
...
<div class="well">
    <div class="form-group">
    		<label for="happy" class="col-sm-3 col-md-3 control-label ">Buscar por rango de Años ?</label>

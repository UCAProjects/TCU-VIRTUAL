					...
					<div class="ingreso ingresoTamano">
						<form class="">
							...
							<ul class="nav nav-tabs" id="nav">
								<li class="active">
									<a href="#nav" onclick="modeLecture()">
										<i class="fas fa-book"></i> Modo Lectura</a>
								</li>
								<li>
									<a href="#nav" onclick="modeRevision()">
										<i class="fas fa-edit"></i> Modo Revisión</a>
								</li>
							</ul>
							<br>
								...
								<div class="row">
									<div class="col-md-3">
										<fieldset>
											...
											<a href="<?php echo $linkConclusion?>" target="_blank">
												<i class="far fa-file-alt"></i> Carta Conclusión</a>
											<br>
											<a href="<?php echo $linkBitacora?>" target="_blank">
												<i class="far fa-file-alt"></i> Bitácora </a>
										</fieldset>
									</div>
									<div class="col-md-9">
										<fieldset>
										...
										<fieldset>
											...
											<div id="divDocument" style="background-color: white;">
												<div style="padding: 40px;">
													<center>
														<img src="../../img/uca.png" alt="Smiley face">
														<br>
														<br>
														<br>
														<br>

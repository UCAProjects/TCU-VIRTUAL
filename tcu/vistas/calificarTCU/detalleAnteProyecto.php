                        ...
                        <div class="row well">
                            <div class="col-md-7">
                                <div class="">
                                    ...
                                    <div id="divDocument" style="background-color: white;padding: 40px;">
                                            <center>
                            ...
                            <div class="col-md-5" class="">                   
                                <div style="resize: both;"><br>
                                    ...
                                    <center><textarea id="txtA_observaciones" style="width:100%" placeholder="Observaciones" rows="30"><?php
                                    if($estadoGuardado == 6){

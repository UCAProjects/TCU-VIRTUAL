...
<body>
  ...
  ?>
				...
				<div class="">
					...
					<div class="ingreso ingresoTamano">
						...
						<div class="formulario">
							<ul>
								<li>
									<label for="temaProyecto">Integrantes</label>
								</li>
    ...
    if($tipo == 1){// Tipo 1 quiere decir que la petición la realizó un estudiante
      $query = "select grupo from tigrupou_tcu.estudiantes where codigo like $codigo;";
 ...
 ?>
          ...
          <![endif]-->
                              ...
                              ?>
								...
								<li>
									<button id="btnConfirmar" name="btnConfirmar">Abandonar Grupo</button>
									<br>
									<br>
									<br>
								</li>

...
<head>
	...
	<meta name="description" content="TCU-VIRTUAL es herramienta desarrollada por el departamento de Informática de la UCA, con el fin que los estudiantes de esta institución puedan desarrollar su Trabajo Comunal Universitario de forma digital." />
</head>
				...
				<ul class="lista-informacion clearfix">
					<li>
						<div class="tabla-informacion">
							...
							<p class="info">En esta sección encontrará una guía para el uso correcto del sistema de TCU Virtual y cómo completar la información.
							</p>
					...
					<li>
						<div class="tabla-informacion">
							...
							<p class="info">
								En esta sección encontrará el Reglamento del Trabajo Comunal Universitario y un video tutorial sobre el desarrollo del TCU.
							</p>
					...
					<li>
						<div class="tabla-informacion">
							<h3>Contacto</h3>
							<p class="info">
								Para cualquier duda o consulta sobre el Sistema de TCU, puede ponerse en contacto con nosotros, accediendo al formulario
								de contacto.
							</p>
					...
					<div class="ingreso">
						...
						<div class="formulario clearfix" novalidate>
							<ul>
								...
								<li>
									<input type="text" name="usuario" id="usuario" placeholder="Digite su usuario" autocomplete="on" required>
								</li>
								<li>
									<label for="password">Contraseña:</label>
								</li>
								<li>
									<input type="password" name="password" id="password" placeholder="Digite su contraseña" autocomplete="on" required>
								</li>
								<li>
									<input type="radio" name="tipoUsuario" class="seleccionar" id="estudiante" value="1">
									<label for="estudiante">Estudiante</label>
								</li>
								<li>
									<input type="radio" name="tipoUsuario" class="seleccionar" id="funcionario" value="2">
									<label for="estudiante">Funcionario</label>
								</li>
								<li>
									<button onclick="registroUsuario()">Registro</button>
